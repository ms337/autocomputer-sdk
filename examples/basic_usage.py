...
async def main():
    ...
    loaded_workflow = Workflow.from_json_file(
        "/Users/madhav/flow/autocomputer-flow/src/autocomputer_flow/services/workflow/saved/test_single_prompt.json"
    )
    ...
    user_inputs_static = {
        "task": "Find the score for leafs and panthers.",
        # "another_input": 123 # This would cause validation error if not in workflow
    }
